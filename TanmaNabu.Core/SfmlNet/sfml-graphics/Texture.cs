...
namespace SFML.Graphics
{
    ...
    public class Texture : ObjectBase
    {
        ...
        ////////////////////////////////////////////////////////////
        public void Update(Window.Window window) => Update(window, 0, 0);
        ...
        /// <param name="y">Y offset in the texture where to copy the source pixels</param>
        ////////////////////////////////////////////////////////////
        public void Update(Window.Window window, uint x, uint y) => sfTexture_updateFromWindow(CPointer, window.CPointer, x, y);
        ...
        ////////////////////////////////////////////////////////////
        public static void Bind(Texture texture) => sfTexture_bind(texture != null ? texture.CPointer : IntPtr.Zero);
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[Texture] Size({Size}) Smooth({Smooth}) Repeated({Repeated})";

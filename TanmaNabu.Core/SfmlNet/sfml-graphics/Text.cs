...
namespace SFML.Graphics
{
    ...
    public class Text : Transformable, Drawable
    {
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[Text] FillColor({FillColor}) OutlineColor({OutlineColor}) String({DisplayedString}) Font({Font}) CharacterSize({CharacterSize}) OutlineThickness({OutlineThickness}) Style({Style})";
        ...
        [DllImport(SfmlSettings.CsfmlGraphicsPath, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity, Obsolete]

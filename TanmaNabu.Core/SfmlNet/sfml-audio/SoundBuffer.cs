...
namespace SFML.Audio
{
    ...
    public class SoundBuffer : ObjectBase
    {
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[SoundBuffer] SampleRate({SampleRate}) ChannelCount({ChannelCount}) Duration({Duration})";
        ...
        [DllImport(SfmlSettings.CsfmlAudioPath, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]

...
namespace SFML.Graphics
{
    ...
    public class RenderWindow : Window.Window, RenderTarget
    {
        ...
        ////////////////////////////////////////////////////////////
        public void Draw(Drawable drawable, RenderStates states) => drawable.Draw(this, states);
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[RenderWindow] Size({Size}) Position({Position}) Settings({Settings}) DefaultView({DefaultView}) View({GetView()})";
        ...
        ////////////////////////////////////////////////////////////
        public override bool WaitEvent(out Event eventToFill) => sfRenderWindow_waitEvent(CPointer, out eventToFill);
        ...
        ////////////////////////////////////////////////////////////
        public override void InternalSetMousePosition(Vector2i position) => sfMouse_setPositionRenderWindow(position, CPointer);
        ...
        ////////////////////////////////////////////////////////////
        public override Vector2i InternalGetTouchPosition(uint Finger) => sfTouch_getPositionRenderWindow(Finger, CPointer);
        ...
        [DllImport(SfmlSettings.CsfmlGraphicsPath, CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]

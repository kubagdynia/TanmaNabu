...
namespace SFML.Audio
{
    ...
    public class SoundBufferRecorder : SoundRecorder
    {
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[SoundBufferRecorder] SampleRate({SampleRate}) SoundBuffer({SoundBuffer})";
        ...
        /// </summary>
        ////////////////////////////////////////////////////////////
        protected override void OnStop() => mySoundBuffer = new SoundBuffer(mySamplesArray.ToArray(), 1, SampleRate);

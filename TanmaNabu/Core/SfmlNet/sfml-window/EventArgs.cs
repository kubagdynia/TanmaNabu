...
namespace SFML.Window
{
    ...
    public class KeyEventArgs : EventArgs
    {
        ...
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[KeyEventArgs] Code({Code}) Alt({Alt}) Control({Control}) Shift({Shift}) System({System})";
    ...
    public class TextEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[TextEventArgs] Unicode({Unicode})";
    ...
    public class MouseMoveEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[MouseMoveEventArgs] X({X}) Y({Y})";
    ...
    public class MouseButtonEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[MouseButtonEventArgs] Button({Button}) X({X}) Y({Y})";
    ...
    public class MouseWheelEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[MouseWheelEventArgs] Delta({Delta}) X({X}) Y({Y})";
    ...
    public class MouseWheelScrollEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[MouseWheelScrollEventArgs] Wheel({Wheel}) Delta({Delta}) X({X}) Y({Y})";
    ...
    public class JoystickMoveEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[JoystickMoveEventArgs] JoystickId({JoystickId}) Axis({Axis}) Position({Position})";
    ...
    public class JoystickButtonEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[JoystickButtonEventArgs] JoystickId({JoystickId}) Button({Button})";
    ...
    public class JoystickConnectEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[JoystickConnectEventArgs] JoystickId({JoystickId})";
    ...
    public class SizeEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[SizeEventArgs] Width({Width}) Height({Height})";
    ...
    public class TouchEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[TouchEventArgs] Finger({Finger}) X({X}) Y({Y})";
    ...
    public class SensorEventArgs : EventArgs
    {
        ...
        /// <returns>String description of the object</returns>
        ////////////////////////////////////////////////////////////
        public override string ToString() => $"[SensorEventArgs] Type({Type}) X({X}) Y({Y}) Z({Z})";

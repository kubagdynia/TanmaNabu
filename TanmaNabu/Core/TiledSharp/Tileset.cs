...
namespace TiledSharp
{
    public class TmxTileset : TmxDocument, ITmxElement
    {
        ...
        public void Load(XElement xTileset, string tmxDir = "")
        {
            ...
            if (source != null)
            {
                ...
                XDocument xDocTileset = ReadXml(source);
                TmxTileset ts = new TmxTileset(xDocTileset, TmxDirectory);
                Source = ts.Source;
                Name = ts.Name;
            ...
            else
            {
                ...
                {
                    foreach (XElement element in xTerrainType.Elements("terrain"))
                    {
                ...
                {
                    TmxTilesetTile tile = new TmxTilesetTile(xTile, Terrains, tmxDir);
                    Tiles.Add(tile);
                }
    ...
    public class TmxTilesetTile
    {
        ...
        public Collection<TmxTerrain> TerrainEdges { get; private set; } = new Collection<TmxTerrain>();
        ...
        public TmxTilesetTile(XElement xTile, TmxList<TmxTerrain> Terrains, string tmxDir = "")
        {
            ...
            foreach (XElement element in xTile.Elements("objectgroup"))
            {
            ...
            {
                foreach (XElement element in xTile.Element("animation").Elements("frame"))
                {
